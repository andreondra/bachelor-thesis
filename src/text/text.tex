...
%---------------------------------------------------------------
Primárním cílem práce bylo vytvořit funkční softwarový emulátor konzole Nintendo Entertainment System. Tento primární cíl zahrnoval využití ve výuce, což vyžadovalo vývoj přehledného grafického rozhraní. Tento primární cíl byl v~průběhu 2~let vývoje bakalářského projektu značně rozšířen o~cíle sekundární, kdy nejdůležitějším byl vývoj univerzální platformy pro vývoj emulátorů.

Pro dosažení primárního cíle byla nutná důkladná analýza. Za pomocí hardwarových manuálů, ale i~komunitní dokumentace byl vytvořen přehled principů stojících za fungováním jednotlivých komponent konzole NES. Výsledky analýzy byly podrobně popsány v~textu bakalářské práce, což z~textu vytvořilo užitečný přehled pro potenciální zájemce nejen o~vývoj vlastního emulátoru NES, ale i~o~pochopení principu fungování velmi rozšířené herní konzole.