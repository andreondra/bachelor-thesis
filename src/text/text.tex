...
\section{Zvukový syntezátor Audio Processing Unit}
\label{sec:APU}
...
\[\textrm{\emph{výstup}} = suma\_pulz + suma\_tnd\]
	
kde jsou jednotlivé složky vyjádřitelné jako
	
\[suma\_pulz = \frac{95,88}{\frac{8128}{pulz1 + pulz2} + 100}\]

\[suma\_tnd = \frac{159,79}{\frac{1}{\frac{\textrm{\emph{trojúhelník}}}{8227} + \frac{\textrm{\emph{šum}}}{12241} + \frac{pcm}{22638}} + 100}\]
