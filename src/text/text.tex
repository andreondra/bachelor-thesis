...
\subsubsection{Pomocné knihovny}
Aby byla naplněna filosofie celé platformy, je třeba se nejprve zamyslet nad volbou dalších nástrojů, které pomohou k~dosažení cíle.
...
Při návrhu komunikace mezi komponentami musí být brána v~potaz i~reálná implementace. Lze vyjít z~hardwarového schématu konzole, které je obsahem příloh jako obrázek~\ref{fig:nes001-hw}.
