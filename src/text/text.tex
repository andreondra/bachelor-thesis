...
\begin{table}[ht!]
	...
	\begin{tabular}{|c|c|c|c|}
		...
		\hline
		akumulátor & A & 8 & zpracovávané hodnoty \\
		\hline
...
zde popsat v návaznosti na adr. režimy, viz str. 168 HW manuálu, popsat pipelining (str. 71)
