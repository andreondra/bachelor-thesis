...
\begin{definition}[Sběrnice]
	\enquote{Je to skupina vodičů, k~nimž jsou připojeny vstupy a~výstupy jednotlivých jednotek. (\dots) Vodiče lze rozdělit na adresové, datové, řídicí a~stavové~\cite{Pluhacek1995:plp}.}
\end{definition}
